...
export default defineComponent({
    ...
    data() {
        return {
            isReady: false,
            image: '../../assets/images/refuel2.jpg',
            header: 'Tankstelle',
            summary: `Das hier ist nur ein Beispiel.
                      Schreib hier was immer du willst als Text.
                      <p style="color: yellow">Start work today!</p>`,
            locales: {
                LABEL_DECLINE: 'Abbrechen',
                LABEL_ACCEPT: 'Bestätigen',
            },
            maxAmount: undefined,
            amount: 1,
        };
